...
export interface DateTimeFilter {
    ...
    ge?: (Scalars['DateTime'] | null);
    le?: (Scalars['DateTime'] | null);
    in?: ((Scalars['DateTime'] | null)[] | null);
}
export interface MutationGenqlSelection {
    createTodo?: (TodoGenqlSelection & {
        __args: {
            input: TodoInput;
        };
    });
...
export interface StringFilter {
    ...
    allofterms?: (Scalars['String'] | null);
    anyofterms?: (Scalars['String'] | null);
    alloftext?: (Scalars['String'] | null);
    anyoftext?: (Scalars['String'] | null);
    lt?: (Scalars['String'] | null);
    le?: (Scalars['String'] | null);
    gt?: (Scalars['String'] | null);
    ge?: (Scalars['String'] | null);
    in?: ((Scalars['String'] | null)[] | null);
}
export interface SubscriptionGenqlSelection {
    event?: (MutationEventGenqlSelection & {
        __args?: {
...
export interface TodoFilter {
    ...
    completed?: (BooleanFilter | null);
    createdAt?: (DateTimeFilter | null);
    and?: ((TodoFilter | null)[] | null);
    or?: ((TodoFilter | null)[] | null);
    not?: (TodoFilter | null);
}
...
export declare const isMutationEvent: (obj?: {
    __typename?: any;
} | null) => obj is MutationEvent;
export declare const isQuery: (obj?: {
    __typename?: any;
} | null) => obj is Query;
export declare const isSubscription: (obj?: {
    __typename?: any;
} | null) => obj is Subscription;
export declare const isTodo: (obj?: {
    __typename?: any;
} | null) => obj is Todo;
export declare const enumMutationType: {
    CREATE: "CREATE";
    UPDATE: "UPDATE";
    DELETE: "DELETE";
};
