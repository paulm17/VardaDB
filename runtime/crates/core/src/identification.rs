...
use restate_types::health::{AdminStatus, NodeStatus, WorkerStatus};
...
impl Identification {
    ...
    pub fn get() -> Self {
        ...
        let (node_status, admin_status, worker_status, bound_addresses, advertised_addresses) =
            TaskCenter::with_current(|tc| {
                ...
                let advertised_addresses =
                    collect_advertised_addresses(&configuration, address_book);
                (
