...
//                     the partition processor because the version of the running runtime
...
pub(crate) fn describe_metrics() {
    describe_gauge!(
        ...
        Unit::Count,
        "A partition requires a newer runtime version and is blocked from starting on this node"
    );
    describe_histogram!(
