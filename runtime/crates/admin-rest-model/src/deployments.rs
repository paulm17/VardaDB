...
impl From<restate_types::schema::deployment::Deployment> for Deployment {
    fn from(value: restate_types::schema::deployment::Deployment) -> Self {
        match value.ty {
            DeploymentType::Http {
                address,
                protocol_type,
                ...
                protocol_type,
                http_version,
                additional_headers: value.additional_headers.into(),
