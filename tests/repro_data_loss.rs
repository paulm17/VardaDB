...
fn test_data_persistence_after_restart() {
    ...
    // 1. Start Storage, Create DB, Insert Data
    {
        ...
        for i in 0..100 {
            ...
            // Use put_with_lww
            storage.put_with_lww(db_name, i as u64, &key, &value, &timestamp).unwrap();
        }
    ...
    // 2. Restart Storage
    {
        ...
        assert!(databases.contains(&db_name.to_string()), "Database should persist");
        ...
        for i in 0..100 {
            ...
            assert!(result.is_some(), "Data for item {} should exist after restart", i);
