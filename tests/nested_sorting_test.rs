...
async fn test_nested_sorting() {
    ...
    ";
    let res_json = schema.execute_with_resolver(query_asc, resolver.clone()).await;
    ...
    let posts_desc = res_desc["data"]["queryUser"][0]["posts"].as_array().expect("Expected posts array");
