...
async fn test_execution_flow() {
    ...
    impl Resolver for MockMapResolver {
        ...
        fn create_node(&self, _type_name: &str, _fields: std::collections::HashMap<String, async_graphql::Value>, _uniques: &[String], _inverses: &[vardadb::engine::resolver::InverseInfo], _search: &std::collections::HashMap<String, Vec<String>>, _: Option<&VectorConfig>) -> Result<u64, String> {
             Ok(100)
        }
        fn scan_nodes(&self, _t: &str, _f: std::collections::HashMap<String, async_graphql::Value>, _sort: std::collections::HashMap<String, async_graphql::Value>, _lim: Option<usize>, _cur: Option<String>, _: &[String], _near_vector: Option<Vec<f64>>) -> Vec<u64> { vec![] }
        fn resolve_list(&self, _: u64, _: &str, _: std::collections::HashMap<String, async_graphql::Value>, _: std::collections::HashMap<String, async_graphql::Value>, _: Option<usize>, _: Option<String>, _near_vector: Option<Vec<f64>>) -> Result<Vec<u64>, String> { Ok(vec![]) }
        fn update_node(&self, _: &str, _: u64, _: std::collections::HashMap<String, async_graphql::Value>, _: &[String], _: &[vardadb::engine::resolver::InverseInfo], _search: &std::collections::HashMap<String, Vec<String>>, _: Option<&VectorConfig>) -> Result<(), String> { Ok(()) }
