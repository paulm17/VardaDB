...
export declare class ErrorFrame<T, J extends boolean> extends Frame<T, J> {
	...
	constructor(query: number, stats: QueryStats | undefined, error: {
		code: number;
		message: string;
	});
...
export declare const MINIMUM_VERSION = "2.0.0";
...
interface DeleteOptions {
	what: _RecordId | _RecordIdRange | Table;
	output?: Output;
	timeout?: Duration;
	version?: DateTime;
	transaction: Uuid | undefined;
...
export declare abstract class SurrealQueryable {
	 ...
	 */
	select<T>(recordId: _RecordId): SelectPromise<RecordResult<T> | undefined, T>;
	/**
	 ...
	 */
	create<T>(recordId: _RecordId): CreatePromise<RecordResult<T>, T>;
	/**
	 ...
	 */
	update<T>(recordId: _RecordId): UpdatePromise<RecordResult<T>, T>;
	/**
	 ...
	 */
	upsert<T>(recordId: _RecordId): UpsertPromise<RecordResult<T>, T>;
	/**
	 ...
	 */
	delete<T>(recordId: _RecordId): DeletePromise<RecordResult<T>>;
	/**
...
export declare class Surreal extends SurrealSession implements EventPublisher<SurrealEvents> {
	 ...
	 */
	export(options?: Partial<SqlExportOptions>): Promise<string>;
	/**
 ...
 */
export declare class ResponseError extends SurrealError {
	name: string;
