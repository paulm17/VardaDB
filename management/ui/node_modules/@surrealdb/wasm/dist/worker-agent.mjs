...
function __wasm_bindgen_func_elem_28605(arg0, arg1) {
	wasm.__wasm_bindgen_func_elem_28605(arg0, arg1);
}
function __wasm_bindgen_func_elem_26534(arg0, arg1, arg2) {
	try {
		const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
		wasm.__wasm_bindgen_func_elem_26534(retptr, arg0, arg1, addHeapObject(arg2));
...
function __wasm_bindgen_func_elem_33102(arg0, arg1) {
	wasm.__wasm_bindgen_func_elem_33102(arg0, arg1);
}
function __wasm_bindgen_func_elem_33436(arg0, arg1, arg2) {
	wasm.__wasm_bindgen_func_elem_33436(arg0, arg1, addHeapObject(arg2));
}
function __wasm_bindgen_func_elem_38871(arg0, arg1, arg2, arg3) {
	wasm.__wasm_bindgen_func_elem_38871(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
var IntoUnderlyingSource = class IntoUnderlyingSource {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
...
const SurrealWasmEngineFinalization = typeof FinalizationRegistry === "undefined" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((ptr) => wasm.__wbg_surrealwasmengine_free(ptr >>> 0, 1));
var SurrealWasmEngine = class SurrealWasmEngine {
	static __wrap(ptr) {
		ptr = ptr >>> 0;
	...
	*/
	export(config) {
		const ret = wasm.surrealwasmengine_export(this.__wbg_ptr, isLikeNone(config) ? 0 : addHeapObject(config));
		return takeObject(ret);
	}
	/**
	* @param {string} input
	...
	*/
	import(input) {
		...
		const ret = wasm.surrealwasmengine_import(this.__wbg_ptr, ptr0, len0);
		return takeObject(ret);
	}
	/**
	* @param {string} endpoint
	* @param {ConnectionOptions | null} [opts]
...
if (Symbol.dispose) SurrealWasmEngine.prototype[Symbol.dispose] = SurrealWasmEngine.prototype.free;
...
async function __wbg_load(module$1, imports) {
	if (typeof Response === "function" && module$1 instanceof Response) {
		if (typeof WebAssembly.instantiateStreaming === "function") try {
			...
			const validResponse = module$1.ok && EXPECTED_RESPONSE_TYPES.has(module$1.type);
			if (validResponse && module$1.headers.get("Content-Type") !== "application/wasm") console.warn("`WebAssembly.instantiateStreaming` failed because your server does not serve Wasm with `application/wasm` MIME type. Falling back to `WebAssembly.instantiate` which is slower. Original error:\n", e);
			else throw e;
		}
		const bytes = await module$1.arrayBuffer();
		return await WebAssembly.instantiate(bytes, imports);
	} else {
		const instance$1 = await WebAssembly.instantiate(module$1, imports);
		if (instance$1 instanceof WebAssembly.Instance) return {
			instance: instance$1,
			module: module$1
		};
		else return instance$1;
	}
}
function __wbg_get_imports() {
	...
	imports.wbg.__wbg_advance_11d4c28c7775b169 = function() {
		return handleError(function(arg0, arg1) {
			getObject(arg0).advance(arg1 >>> 0);
		}, arguments);
	};
	imports.wbg.__wbg_append_45ddba58b0706f62 = function() {
		return handleError(function(arg0, arg1, arg2, arg3, arg4) {
			getObject(arg0).append(getStringFromWasm0(arg1, arg2), getStringFromWasm0(arg3, arg4));
		}, arguments);
	};
	imports.wbg.__wbg_append_892c5e2d5bdd60ac = function() {
	...
	imports.wbg.__wbg_append_cb0bba4cf263a60b = function() {
	...
	imports.wbg.__wbg_new_3c3d849046688a66 = function(arg0, arg1) {
		try {
			...
			var cb0 = (arg0$1, arg1$1) => {
				...
				state0.a = 0;
				try {
					return __wasm_bindgen_func_elem_38871(a, state0.b, arg0$1, arg1$1);
				} finally {
					state0.a = a;
				}
			};
	...
	imports.wbg.__wbg_new_6f694bb0585846e0 = function() {
		return handleError(function() {
	...
	imports.wbg.__wbg_new_with_u8_array_sequence_and_options_0c1d0bd56d93d25a = function() {
		return handleError(function(arg0, arg1) {
	...
	imports.wbg.__wbg_now_98430d19d580dbab = function() {
		return handleError(function() {
			const ret = Date.now();
			return ret;
		}, arguments);
	...
	imports.wbg.__wbg_openCursor_7d55ec88c2b1e4ad = function() {
		return handleError(function(arg0, arg1, arg2) {
	...
	imports.wbg.__wbindgen_cast_384d2f71078555b5 = function(arg0, arg1) {
		const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_33421, __wasm_bindgen_func_elem_33436);
		return addHeapObject(ret);
	};
	imports.wbg.__wbindgen_cast_4157ed8299e3187f = function(arg0, arg1) {
		const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_28572, __wasm_bindgen_func_elem_28605);
		return addHeapObject(ret);
	};
	...
	imports.wbg.__wbindgen_cast_838e1f610f2a2add = function(arg0, arg1) {
		const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_26485, __wasm_bindgen_func_elem_26534);
		return addHeapObject(ret);
	};
	...
	imports.wbg.__wbindgen_cast_ee2e87a705e4e7cf = function(arg0, arg1) {
		const ret = makeMutClosure(arg0, arg1, wasm.__wasm_bindgen_func_elem_33093, __wasm_bindgen_func_elem_33102);
		return addHeapObject(ret);
	};
...
function __wbg_finalize_init(instance$1, module$1) {
	wasm = instance$1.exports;
...
async function __wbg_init(module_or_path) {
	...
	if (typeof module_or_path === "undefined") module_or_path = new URL("surrealdb_bg.wasm", import.meta.url);
	const imports = __wbg_get_imports();
	if (typeof module_or_path === "string" || typeof Request === "function" && module_or_path instanceof Request || typeof URL === "function" && module_or_path instanceof URL) module_or_path = fetch(module_or_path);
	const { instance: instance$1, module: module$1 } = await __wbg_load(await module_or_path, imports);
	return __wbg_finalize_init(instance$1, module$1);
}
var surrealdb_default = __wbg_init;

//#endregion
//#region src-ts/common.ts
function readNotifications(engine, handle, signal) {
	let cancelled = false;
	const cancel = () => {
		cancelled = true;
	};
	(async () => {
		try {
			...
			while (!cancelled && !signal?.aborted) {
				...
				if (done || cancelled || signal?.aborted) break;
				handle(value);
			}
			if (!cancelled && !signal?.aborted) await reader.cancel();
		} catch {}
	})();
	return cancel;
}
async function initializeLibrary() {
	...
	await surrealdb_default(wasmCode);
}

//#endregion
//#region src-ts/worker/worker-contract.ts
const RequestType = {
	CONNECT: "connect",
	EXECUTE: "execute",
...
//#endregion
//#region src-ts/worker/worker-agent.ts
let instance;
...
async function handleConnect(request) {
	...
	cancelNotifications = readNotifications(instance, (data) => {
		self.postMessage({
...
async function handleExecute(request) {
	if (!instance) throw new ConnectionUnavailableError();
	return instance.execute(request.payload);
}
async function handleImportSql(request) {
	if (!instance) throw new ConnectionUnavailableError();
	return instance.import(request.data);
}
async function handleExportSql(request) {
	if (!instance) throw new ConnectionUnavailableError();
	return instance.export(request.options);
}
function handleClose() {
	cancelNotifications?.();
	cancelNotifications = void 0;
	abortController?.abort();
...
self.addEventListener("message", async (event) => {
	...
	try {
		...
		self.postMessage({
			...
			data: result
		}, result instanceof Uint8Array ? { transfer: [result.buffer] } : void 0);
	} catch (error) {
		self.postMessage({
			id: message.id,
