...
const bashHighlighting = highlight.styleTags({
  "while do done until for in case esac if then elif else fi": highlight.tags.controlKeyword,
  IORedirect: highlight.tags.operator,
