...
export async function startConfigSync() {
	...
	// Force update sandbox connection to current defaults
	// This ensures we don't get stuck with stale mem:// config from storage
	// when we want to point to the local server.
	config.sandbox = createBaseConfig().sandbox;
