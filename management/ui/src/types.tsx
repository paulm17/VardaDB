...
export type SupportConversationStateId = "open" | "closed" | "snoozed";
...
export interface SupportTicketTypeMinimal {
	id: string;
	name: string;
}

export interface SupportTicketType extends SupportTicketTypeMinimal {
	description: string;
	attributes: SupportTicketTypeAttribute[];
}

export interface SupportTicketTypeAttributeListOption {
	label: string;
	archived: boolean;
	id: string;
	description?: string;
...
export interface SupportTicketTypeAttribute {
	id: string;
	name: string;
	description?: string;
	order: number;
	data_type: string;
	input_options?: {
		list_options?: SupportTicketTypeAttributeListOption[];
		multiline?: boolean;
...
export interface SupportTicketPart {
	id: string;
	part_type: string;
...
export interface SupportTicket {
	...
	description: string;
	state: SupportTicketState;
	type: SupportTicketTypeMinimal;
	created_at: number;
	updated_at: number;
	contacts: SupportContact[];
	parts: SupportTicketPart[];
	open: boolean;
...
export interface SupportConversationReplyRequest {
	body: string;
	attachment_files?: {
		content_type: string;
		data: string;
...
export interface SupportConversationStateRequest {
...
export interface SupportConversationPart {
	id: string;
	part_type: string;
	body: string;
	created_at: number;
	...
	state: SupportConversationStateId;
	author: SupportUser;
}
...
export interface SupportConversation {
	...
	updated_at: number;
	contacts: SupportContact[];
	last_response_author: SupportUser;
	parts: SupportConversationPart[];
	initial_part: SupportConversationPart;
	open: boolean;
	read: boolean;
	priority: boolean;
	hasTicket: boolean;
...
export interface SupportArticle {
	...
	updated_at: number;
	url: string;
	collection?: SupportCollectionShallow;
}

export interface SupportCollectionShallow {
	id: string;
	name: string;
	description: string;
	icon: string;
...
export interface SupportCollection extends SupportCollectionShallow {
