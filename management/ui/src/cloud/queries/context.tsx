...
import {
	...
	SupportArticle,
	SupportCollection,
	SupportCollectionShallow,
	SupportTicket,
	SupportTicketTypeAttribute,
} from "~/types";
...
export function useConversationsQuery() {
	...
	return useQuery({
		...
		queryFn: async () => {
			return fetchContextAPI<SupportConversation[]>(`/cloud/conversations`, env);
		},
	});
}
...
export function useCloudOrganizationTicketsQuery(organizationId?: string) {
	...
	return useQuery({
		...
		queryFn: async () => {
			return fetchContextAPI<SupportTicket[]>(`/cloud/org/${organizationId}/tickets`, env);
		},
	});
}
...
export function useCloudOrganizationTicketAttributesQuery(organizationId?: string) {
	...
	return useQuery({
		...
		enabled: !!organizationId && flags.support_tickets,
		queryFn: async () => {
			return fetchContextAPI<SupportTicketTypeAttribute[]>(
...
export function useCloudConversationQuery(conversationId?: string) {
	...
	return useQuery({
		...
		queryFn: async () => {
			return fetchContextAPI<SupportConversation>(
...
export function useSupportCollectionsQuery() {
	...
	return useQuery({
		...
		queryFn: async () => {
			return fetchContextAPI<SupportCollectionShallow[]>(`/help/collections`, env);
		},
	});
}
...
export function useSupportCollectionQuery(collectionId?: string) {
	...
	return useQuery({
		...
		queryFn: async () => {
			return fetchContextAPI<SupportCollection>(
...
export function useSupportArticleQuery(articleId?: string) {
	...
	return useQuery({
		...
		enabled: !!articleId,
		queryFn: async () => {
			return fetchContextAPI<SupportArticle>(`/help/articles/${articleId}`, env);
		},
	});
}
...
export function useSearchHelpArticlesQuery(query: string) {
	...
	return useQuery({
		...
		queryFn: async () => {
			return fetchContextAPI<SupportArticle[]>(`/help/articles/search`, env, {
				method: "POST",
				body: JSON.stringify({
					query: query,
				}),
